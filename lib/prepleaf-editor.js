...
var PrpeleafEditorGlobalContext = React__default['default'].createContext({
  readOnly: false,
...
var katexCssCdn = /*#__PURE__*/React__default['default'].createElement("link", {
  rel: "stylesheet",
...
var TeXEditor = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(TeXEditor, [{
    ...
    value: function render() {
      ...
      if (readOnly) {
        return /*#__PURE__*/React__default['default'].createElement("div", null, katexCssCdn, /*#__PURE__*/React__default['default'].createElement(PrpeleafEditorGlobalContext.Provider, {
      ...
      return /*#__PURE__*/React__default['default'].createElement("div", {
      ...
      }, katexCssCdn, /*#__PURE__*/React__default['default'].createElement("div", {
        ...
        handleDroppedFiles: function handleDroppedFiles(selection, files) {
          var updatedSelectionEditorState = EditorState.acceptSelection(_this2.state.editorState, selection);
...
var isStandardArguments = function isArguments(value) {
	...
	return toStr$5.call(value) === '[object Arguments]';
};
...
var isLegacyArguments = function isArguments(value) {
	...
	return value !== null &&
		...
		typeof value.length === 'number' &&
		value.length >= 0 &&
		toStr$5.call(value) !== '[object Array]' &&
...
var throwTypeError = function () { throw new $TypeError$2(); };
...
var INTRINSICS = {
	...
	'%TypeErrorPrototype%': $TypeError$2.prototype,
...
var isRegex = function isRegex(value) {
	...
	if (!hasToStringTag$1) {
		return toStr$2.call(value) === regexClass;
	}
...
var QuillEditorController = /*#__PURE__*/function (_React$Component2) {
  ...
  _createClass(QuillEditorController, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props;
          _this$props.customRef;
          var otherProps = _objectWithoutProperties(_this$props, ["customRef"]);

      return /*#__PURE__*/React__default['default'].createElement(QuillEditor, _extends({}, otherProps, {
  ...
  _createClass(PrepleafEditor, [{
    ...
    value: function render() {
      if (this.state.editor === 'Quill') {
        return /*#__PURE__*/React__default['default'].createElement(QuillEditorController, this.props);
      } else {
