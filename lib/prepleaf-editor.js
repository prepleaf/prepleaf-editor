...
var immutable_1 = immutable.Iterable;
var immutable_2 = immutable.Seq;
var immutable_3 = immutable.Collection;
var immutable_4 = immutable.Map;
var immutable_5 = immutable.OrderedMap;
var immutable_6 = immutable.List;
var immutable_7 = immutable.Stack;
var immutable_8 = immutable.Set;
var immutable_9 = immutable.OrderedSet;
var immutable_10 = immutable.Record;
var immutable_11 = immutable.Range;
var immutable_12 = immutable.Repeat;
var immutable_13 = immutable.is;
var immutable_14 = immutable.fromJS;
  ...
  _createClass(KatexOutput, [{
    ...
    value: function _update() {
      ...
      this._timer = setTimeout(function () {
        katex.render(_this2.props.content, _this2.containerRef, {
          displayMode: true
        });
      }, 0);
    }
  ...
  _createClass(TeXBlock, [{
    ...
    value: function render() {
      ...
      if (this.state.editMode) {
        ...
        editPanel = /*#__PURE__*/React__default.createElement("div", {
          ...
          onClick: this._save
        }, this.state.invalidTeX ? 'Invalid TeX' : 'Done'), /*#__PURE__*/React__default.createElement("button", {
      ...
      }, /*#__PURE__*/React__default.createElement(KatexOutput, {
        content: texContent,
...
var Image = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Image, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement("div", {
      ...
      }, /*#__PURE__*/React__default.createElement("div", null, url ? /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement("img", {
        ...
        src: url
      }), isLoading ? /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement(Spin, null), /*#__PURE__*/React__default.createElement("div", null, "Loading")) : null, hasError ? /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement("div", null, "An error occurred while loading image. Please check your internet and try again."), /*#__PURE__*/React__default.createElement(Button, {
        onClick: this.retryNow
      }, "Try again")) : null) : /*#__PURE__*/React__default.createElement("span", null, "Image not available")));
    }
  }]);
  ...
  _createClass(ImageBlock, [{
    ...
    value: function render() {
      ...
      if (editMode) {
        ...
        url = this.props.contentState.getEntity(this.props.block.getEntityAt(0)).getData()['url'];
      }
      ...
      }, editMode ? /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement("div", null, "Click here to upload image", /*#__PURE__*/React__default.createElement("input", {
        ref: this.handleRef,
      ...
      }, isUploading ? 'Saving...' : 'Save'), /*#__PURE__*/React__default.createElement("button", {
        onClick: this.cancel
      }, "Cancel"), /*#__PURE__*/React__default.createElement("button", {
        onClick: this.remove
      }, "Remove"))) : null, /*#__PURE__*/React__default.createElement("div", null, url ? /*#__PURE__*/React__default.createElement("img", {
        src: url
      }) : /*#__PURE__*/React__default.createElement("span", null, "No image uploaded")));
    }
  }]);
...
function removeTeXBlock(editorState, blockKey) {
  ...
  var withoutTeX = draftJs.Modifier.removeRange(content, targetRange, 'backward');
  var resetBlock = draftJs.Modifier.setBlockType(withoutTeX, withoutTeX.getSelectionAfter(), 'unstyled');
  var newState = draftJs.EditorState.push(editorState, resetBlock, 'remove-range');
  return draftJs.EditorState.forceSelection(newState, resetBlock.getSelectionAfter());
}

function insertText(editorState, content) {
  var selectionState = editorState.getSelection();
  var contentState = editorState.getCurrentContent(); // const contentStateWithEntity = contentState.createEntity(
  // 	'unstyled',
  // 	'MUTABLE',
  // 	{ content }
  // );
  ...
  var contentStateWithLink = draftJs.Modifier.replaceText(contentState, selectionState, content);
  var newEditorState = draftJs.EditorState.push(editorState, contentStateWithLink, 'insert-characters');
...
function insertInlineEquation(editorState) {
  ...
  var entityKey = contentStateWithEntity.getLastCreatedEntityKey();
  var contentStateWithLink = draftJs.Modifier.applyEntity(contentStateWithEntity, selectionState, entityKey); // const newEditorState = EditorState.set(editorState, {
  // 	currentContent: contentStateWithEntity,
  // });

  var newEditorState = draftJs.EditorState.push(editorState, contentStateWithLink, 'apply-entity');
  return newEditorState;
}
...
var PrpeleafEditorGlobalContext = React__default.createContext({
  readOnly: false,
...
var EditEquation = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(EditEquation, [{
    ...
    value: function render() {
      ...
      }), isValid ? /*#__PURE__*/React__default.createElement(KatexOutput, {
        content: value
      }) : /*#__PURE__*/React__default.createElement("div", {
        className: "pe-portal-error"
      }, "Invalid Equation"), /*#__PURE__*/React__default.createElement("button", {
...
var InlineEquation = /*#__PURE__*/function (_React$Component2) {
  ...
  _createClass(InlineEquation, [{
    ...
    value: function render() {
      ...
      var setIsEditing = this.setIsEditing;
      ...
      var katexDisplay = /*#__PURE__*/React__default.createElement(KatexOutput, {
        inline: true,
      ...
      return /*#__PURE__*/React__default.createElement("span", {
      ...
      }, readOnly ? katexDisplay : /*#__PURE__*/React__default.createElement("span", {
        className: 'inline-equation-display-wrapper' + (readOnly ? ' readonly' : ' editable')
      }, katexDisplay, readOnly ? null : /*#__PURE__*/React__default.createElement("div", {
        ...
        className: "inline-equation-popover-button"
      }, "Remove"))), /*#__PURE__*/React__default.createElement("span", {
        style: {
          width: '0',
          height: 0,
          overflow: 'hidden',
...
_defineProperty(InlineEquation, "contextType", PrpeleafEditorGlobalContext);
...
var compositeDecorator = new draftJs.CompositeDecorator([inlineEquationDecorator]);

var InlineEquation$1 = function InlineEquation() {
  return /*#__PURE__*/React__default.createElement("span", null, "Hello");
};
...
var katexCssCdn = /*#__PURE__*/React__default.createElement("link", {
  rel: "stylesheet",
...
var TeXEditor = /*#__PURE__*/function (_React$Component) {
  ...
  function TeXEditor(props, context) {
            ...
            props: {
              ...
              onFinishEdit: function onFinishEdit(blockKey, newContentState) {
                ...
                _this.setState({
                  ...
                  editorState: draftJs.EditorState.createWithContent(newContentState, compositeDecorator)
                });
              },
    ...
    _defineProperty(_assertThisInitialized(_this), "changeText", function (blockKey, start, end, text) {
      var editorState = _this.state.editorState;
      var emptySelection = draftJs.SelectionState.createEmpty(blockKey);
      var selection = emptySelection.merge({
        anchorOffset: start,
        focusOffset: end
      });
      var newContentState = draftJs.Modifier.replaceText(editorState.getCurrentContent(), selection, text);
      var newEditorState = draftJs.EditorState.createWithContent(newContentState, compositeDecorator);
    ...
    var contentEditorState;

    if (typeof rawContent === 'undefined') {
      contentEditorState = draftJs.EditorState.createEmpty(compositeDecorator);
    } else {
      ...
      contentEditorState = draftJs.EditorState.createWithContent(draftJs.convertFromRaw(modifiedRawContent), compositeDecorator);
    }

    _this.state = {
      editorState: contentEditorState,
      liveTeXEdits: immutable_4(),
      imageEdits: immutable_4(),
      pasteEquationInline: false
    };
    ...
    _this._toggleName = function (editorState, name) {
      _this._onChange(draftJs.RichUtils.toggleInlineStyle(editorState, name));
    };
  ...
  _createClass(TeXEditor, [{
    ...
    value: function resetEditor() {
      var contentEditorState = draftJs.EditorState.createEmpty();
      this.setState({
        editorState: contentEditorState,
        liveTeXEdits: immutable_4()
      });
    ...
    value: function render() {
      ...
      if (readOnly) {
        return /*#__PURE__*/React__default.createElement("div", null, katexCssCdn, /*#__PURE__*/React__default.createElement(PrpeleafEditorGlobalContext.Provider, {
      ...
      return /*#__PURE__*/React__default.createElement("div", {
      ...
      }, katexCssCdn, /*#__PURE__*/React__default.createElement("div", {
      ...
      }, "inline equation"), /*#__PURE__*/React__default.createElement(Button$1, {
        onMouseDown: this.toggleSub,
        className: "TeXEditor-insert-button"
      }, "X", /*#__PURE__*/React__default.createElement("sub", null, "2")), /*#__PURE__*/React__default.createElement(Button$1, {
        onMouseDown: this.toggleSuper,
        className: "TeXEditor-insert-button"
      }, "X", /*#__PURE__*/React__default.createElement("sup", null, "2")), /*#__PURE__*/React__default.createElement(Button$1, {
        onMouseDown: this._insertTeX,
        className: "TeXEditor-insert-button"
      }, "Equation"), /*#__PURE__*/React__default.createElement(Button$1, {
        onMouseDown: this._insertImage,
        className: "TeXEditor-insert-button"
      }, "Image")), /*#__PURE__*/React__default.createElement("div", null, this.state.editInlineEquation ? /*#__PURE__*/React__default.createElement(EditEquation, {
        ...
        onChange: function onChange(text) {
          _this2.changeText(_this2.state.editInlineEquation.blockKey, _this2.state.editInlineEquation.start, _this2.state.editInlineEquation.end, text);
        }
        ...
        type: "checkbox"
      }), "Paste Equation Inline")), /*#__PURE__*/React__default.createElement("div", {
        style: {
          display: 'none'
        }
      }, "For inline eqn use $equatoin in here$: $\\frac", '{2}{3}$'))), /*#__PURE__*/React__default.createElement("div", {
        ...
        onClick: this._focus
      }, /*#__PURE__*/React__default.createElement(PrpeleafEditorGlobalContext.Provider, {
        value: this.contextValue
      }, /*#__PURE__*/React__default.createElement(draftJs.Editor, {
        ...
        handleDroppedFiles: function handleDroppedFiles(selection, files) {
          var updatedSelectionEditorState = draftJs.EditorState.acceptSelection(_this2.state.editorState, selection);
    ...
    get: function get() {
      ...
      return {
        rawContent: draftJs.convertToRaw(editorState.getCurrentContent())
      };
    }
  }, {
    key: "contextValue",
...
var isArray = function isArray(arr) {
	...
	return toStr$7.call(arr) === '[object Array]';
};

var isPlainObject = function isPlainObject(obj) {
	if (!obj || toStr$7.call(obj) !== '[object Object]') {
		return false;
	}
...
var wordUnwatedCharRemover = function wordUnwatedCharRemover(node, delta$1) {
  try {
    var style = node.getAttribute('style');

    if (style.indexOf('mso-spacerun:yes') > -1 || style.indexOf('mso-tab-count') > -1) {
      console.log('yaaayyyyyy, found.', node, delta$1);
      return new delta();
    } else {}
  } catch (error) {}
...
var QuillEditor = /*#__PURE__*/function (_React$Component) {
  ...
  function QuillEditor() {
    ...
    _defineProperty(_assertThisInitialized(_this), "setHtmlContent", function (htmlContent) {
      var quill = _this.quill;
      var delta = quill.clipboard.convert(htmlContent);
      quill.setContents(delta, 'api');
    });

    _defineProperty(_assertThisInitialized(_this), "setContents", function (contents) {
      var quill = _this.quill;
      quill.setContents(contents, 'api');
    });

    _defineProperty(_assertThisInitialized(_this), "onContentsOrHtmlContentChange", function () {
      if (_this.props.contents) {
        _this.setContents(_this.props.contents);
      } else if (_this.props.htmlContent) {
        _this.setHtmlContent(_this.props.htmlContent);
      }
    });

    _defineProperty(_assertThisInitialized(_this), "handleEditorElemRef", function (ref) {
      _this.editorElemRef = ref;
    });
  ...
  _createClass(QuillEditor, [{
    ...
    value: function componentDidMount() {
      ...
      this.quill.on('text-change', function () {
        ...
        onChange && onChange(_this2.quill.getContents());
      });
...
var parseContent = function parseContent(rawContent) {
  try {
...
var QuillEditorController = /*#__PURE__*/function (_React$Component2) {
  _inherits(QuillEditorController, _React$Component2);

  var _super2 = _createSuper(QuillEditorController);

  function QuillEditorController(props, context) {
    var _this3;

    _classCallCheck(this, QuillEditorController);
  ...
  _createClass(QuillEditorController, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var customRef = this.props.customRef;
      customRef && customRef(this);
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          otherProps = _objectWithoutProperties(_this$props, ["customRef"]);

      return /*#__PURE__*/React__default.createElement(QuillEditor, _extends({}, otherProps, {
...
var PrepleafEditor = /*#__PURE__*/function (_React$Component) {
  ...
  function PrepleafEditor(props, context) {
    var _this;
  ...
  _createClass(PrepleafEditor, [{
    ...
    value: function render() {
      if (this.state.editor === 'Quill') {
        return /*#__PURE__*/React__default.createElement(QuillEditorController, this.props);
      } else {
        return /*#__PURE__*/React__default.createElement(TeXEditor, this.props);
      }
    }
  }]);
