...
var keyBindingFn = function keyBindingFn(e) {
  ...
  if (hasCommandModifier(e)) {
    ...
    if (e.keyCode === 55) {
      console.log('unordered-list-item'); // ordered list is 85 which is 'u'
...
var TeXEditor = /*#__PURE__*/function (_React$Component) {
  ...
  function TeXEditor(props, context) {
    ...
    _defineProperty(_assertThisInitialized(_this), "_insertTeX", function () {
      _this.setState({
        liveTeXEdits: Map(),
    ...
    _defineProperty(_assertThisInitialized(_this), "_removeTeX", function (blockKey) {
    ...
    _defineProperty(_assertThisInitialized(_this), "_handleKeyCommand", function (command, editorState) {
    ...
    _defineProperty(_assertThisInitialized(_this), "_toggleName", function (editorState, name) {
      _this._onChange(RichUtils.toggleInlineStyle(editorState, name));
    });

    _defineProperty(_assertThisInitialized(_this), "_focus", function () {
      return _this.editorRef.focus();
    });

    _defineProperty(_assertThisInitialized(_this), "_onChange", function (editorState) {
      _this.setState({
        editorState: editorState
      }, _this.notifyChange);
    });

    _defineProperty(_assertThisInitialized(_this), "notifyChange", function () {
    ...
    _defineProperty(_assertThisInitialized(_this), "markAsInlineEquation", function () {
      _this._onChange(insertInlineEquation(_this.state.editorState));
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "toggleUL", function (e) {
      e === null || e === void 0 ? void 0 : e.preventDefault();
      e === null || e === void 0 ? void 0 : e.stopPropagation();
      var editorState = _this.state.editorState;
      var newEditorState = RichUtils.toggleBlockType(editorState, 'unordered-list-item');

      _this._onChange(newEditorState);
    });

    _defineProperty(_assertThisInitialized(_this), "toggleOL", function (e) {
      e === null || e === void 0 ? void 0 : e.preventDefault();
      e === null || e === void 0 ? void 0 : e.stopPropagation();
      var editorState = _this.state.editorState;
      var newEditorState = RichUtils.toggleBlockType(editorState, 'unordered-list-item');
    ...
    _defineProperty(_assertThisInitialized(_this), "handleBeforeInput", function (chars, editorState) {
      if (_this.handleOLBeforeInput(chars, editorState) !== 'handled') {
        return _this.handleULBeforeInput(chars, editorState);
      } else {
        return 'handled';
      }
    });

    _defineProperty(_assertThisInitialized(_this), "handleULBeforeInput", function (chars, editorState) {
      if (chars === ' ') {
        var selection = editorState.getSelection();
        var currentContent = editorState.getCurrentContent();
        var block = currentContent.getBlockForKey(selection.getStartKey());
        var startOffset = selection.getStartOffset();
        var hyphenOffset = block.getText().indexOf('-'); // Check if the current block contains a hyphen at the start

        if (hyphenOffset === 0 && startOffset === 1) {
          // Convert to unordered-list-item
          var newContentState = Modifier.setBlockType(currentContent, selection.merge({
            anchorOffset: hyphenOffset,
            focusOffset: hyphenOffset + 1
          }), 'unordered-list-item'); // Remove the hyphen by setting an empty text

          var withoutHyphenContentState = Modifier.replaceText(newContentState, selection.merge({
            anchorOffset: hyphenOffset,
            focusOffset: hyphenOffset + 1
          }), '');
          var newEditorState = EditorState.push(editorState, withoutHyphenContentState, 'insert-characters');
    ...
    _defineProperty(_assertThisInitialized(_this), "handleOLBeforeInput", function (chars, editorState) {
      if (chars === ' ') {
        var selection = editorState.getSelection();
        var currentContent = editorState.getCurrentContent();
        var block = currentContent.getBlockForKey(selection.getStartKey());
        var startOffset = selection.getStartOffset();
        var periodOffset = block.getText().indexOf('.'); // Check if the current block contains a period after a number at the start
        ...
        if (periodOffset === 1 && startOffset === 2 && !isNaN(block.getText()[0])) {
          ...
          }), 'ordered-list-item'); // Remove the number and period by setting an empty text

          var withoutNumberAndPeriodContentState = Modifier.replaceText(newContentState, selection.merge({
            anchorOffset: 0,
            focusOffset: periodOffset + 1
          }), ''); // Apply the new content state to the editor state

          var newEditorState = EditorState.push(editorState, withoutNumberAndPeriodContentState, 'insert-characters');
  ...
  _createClass(TeXEditor, [{
    ...
    function render() {
      ...
      return /*#__PURE__*/React__default["default"].createElement("div", {
        ...
        className: "TeXEditor-insert-button"
      }, "OL"), /*#__PURE__*/React__default["default"].createElement(Button, {
        onMouseDown: this.toggleUL,
        className: "TeXEditor-insert-button"
      }, "UL"), /*#__PURE__*/React__default["default"].createElement(Button, {
        ...
        handlePastedFiles: function handlePastedFiles(files) {
          ...
          _this3._onChange(insertImageBlock(editorState, files[0]));
        ...
        handleDroppedFiles: function handleDroppedFiles(selection, files) {
          ...
          _this3._onChange(insertImageBlock(updatedSelectionEditorState, files[0]));
        ...
        handlePastedText: function handlePastedText(text, html, editorState) {
          if (text.indexOf('$$') === 0 && text.substring(text.length - 2)) {
            ...
            _this3._onChange(insertTeXBlock(editorState, content));
